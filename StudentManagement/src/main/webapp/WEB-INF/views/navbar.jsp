	...
	<div class="collapse navbar-collapse " id="navbarNavDropdown">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/studentDetails">Registration
					List <span class="sr-only">(current)</span>
			</a></li>

			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/posts">Posts</a></li>

			<%
				if (session.getAttribute("userrole").equals("Admin")) {
			%>
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/signUp">Add Student</a></li>
			<%
				}
			%>
